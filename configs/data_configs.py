...
DATASETS = {
	...
	"webtoon": {
		'transforms': transforms_config.EncodeTransforms,
		'train_source_root': dataset_paths['webtoon_train'],
		'train_target_root': dataset_paths['webtoon_train'],
		'test_source_root': dataset_paths['webtoon_test'],
		'test_target_root': dataset_paths['webtoon_test']
	}
}