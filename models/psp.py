...
class pSp(nn.Module):
    ...
    def load_weights(self):
        if self.opts.checkpoint_path is not None:
            ...
            self.decoder.load_state_dict(self.__get_keys(ckpt, 'decoder'), strict=False) # True -> False for training 256
            ...
            self.decoder.load_state_dict(ckpt['g_ema'], strict=False) # True -> False for training 256
    ...
    def forward(self, x, latent=None, resize=True, latent_mask=None, input_code=False, randomize_noise=True,
        ...
        images, result_latent = self.decoder([codes], # 이 codes가 styles임. 
